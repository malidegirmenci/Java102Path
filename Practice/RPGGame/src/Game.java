...
public class Game {
    ...
    public  void  start() {
        ...
        */
        Player player = new Player("Ygritte");
        ...
        while (true) {
            ...
            switch (selectArea) {
                ...
                default -> System.out.println("You don't know what you do? C'mon choose one!");
            }
            if (location == null) {
                System.out.println("You are escaped!");
            }
