                ...
                case 3 -> {
                    ...
                    if (behavior == 1) {
                        ...
                        if (!(this.getPlayer().getInventory().getArmorsInBag() == null)) {
                            ...
                            if (behavior == 1) {
                                System.out.println("You sold to " + this.getPlayer().getInventory().getArmorsInBag()[0].name());
                                System.out.println("You earned to " + this.getPlayer().getInventory().getArmorsInBag()[0].price() + " coin");
                                this.getPlayer().setCoin(this.getPlayer().getCoin() + (this.getPlayer().getInventory().getArmorsInBag()[0].price()));
                                System.out.println("Your balance: " + this.getPlayer().getCoin());
                                ...
                                System.out.println("You sold to " + this.getPlayer().getInventory().getArmorsInBag()[1].name());
                                System.out.println("You earned to " + this.getPlayer().getInventory().getArmorsInBag()[1].price() + " coin");
                                this.getPlayer().setCoin(this.getPlayer().getCoin() + (this.getPlayer().getInventory().getArmorsInBag()[1].price()));
                                System.out.println("Your balance: " + this.getPlayer().getCoin());
                                ...
                                System.out.println("You sold to " + this.getPlayer().getInventory().getArmorsInBag()[2].name());
                                System.out.println("You earned to " + this.getPlayer().getInventory().getArmorsInBag()[2].price() + " coin");
                                this.getPlayer().setCoin(this.getPlayer().getCoin() + (this.getPlayer().getInventory().getArmorsInBag()[2].price()));
                                System.out.println("Your balance: " + this.getPlayer().getCoin());
                                this.getPlayer().getInventory().getArmorsInBag()[2] = null;
                            }
                        } else {
        ...
        switch (this.getPlayer().getName()) {
            case "Warrior" -> {
                ...
                for (Armors warriorArmor : Armors.warriorArmors()) {
                    System.out.println(warriorArmor.ID() + "-> " + warriorArmor.name() +
                            " Defence: " + warriorArmor.defence() +
                            " Price: " + warriorArmor.price());
                }
            }
            case "Archer" -> {
                ...
                for (Armors archerArmor : Armors.archerArmors()) {
                    System.out.println(archerArmor.ID() + "-> " + archerArmor.name() +
                            " Defence: " + archerArmor.defence() +
                            " Price: " + archerArmor.price());
                }
            }
            case "Mage" -> {
                System.out.println("Mage's Weapons");
                ...
                for (Armors mageArmor : Armors.mageArmors()) {
                    System.out.println(mageArmor.ID() + "-> " + mageArmor.name() +
                            " Defence: " + mageArmor.defence() +
                            " Price: " + mageArmor.price());
                }
            }
        }
        System.out.println("0-> Leave");
            ...
            switch (this.getPlayer().getName()) {
                case "Warrior" -> {
                    ...
                    if (selectedArmor != null) {
                        if (selectedArmor.price() > this.getPlayer().getCoin()) {
                            System.out.println("You don't have enough coin!");
                        } else {
                            System.out.println(selectedArmor.name() + " purchased");
                            int balance = this.getPlayer().getCoin() - selectedArmor.price();
                            this.getPlayer().setCoin(balance);
                            System.out.println("Remaining of balance: " + this.getPlayer().getCoin());
