...
public abstract class BattleAreas extends Location {
    ...
    private final Random rAQueue = new Random();
    private final Random rDodge = new Random();
    private final Random rItem = new Random();
    ...
    public void playerStats() {
        ...
        System.out.println("Armor: " + this.getPlayer().getInventory().getArmors().name());
